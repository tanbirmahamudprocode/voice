...
function Login() {
  ...
  return (
    ...
    >
      ...
      {/* Animated elements */}
      <motion.div
        className="absolute top-1/3 right-1/3 w-[180px] h-[180px] rounded-full border border-[#ffffff20] z-0"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.1, 0.2, 0.1],
          rotate: [0, 180]
      ...
      <motion.div
        className="absolute bottom-1/3 left-1/3 w-[220px] h-[220px] rounded-full border border-[#ffffff20] z-0"
        animate={{
          scale: [1, 1.3, 1],
      ...
      >
        ...
        >
          <motion.div
            ...
            variants={itemVariants}
          >
            <div className="w-20 h-20 rounded-full bg-gradient-to-r from-[#6c63ff] to-[#00d0ff] flex items-center justify-center">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d0ff] to-[#6c63ff]">Back</span>
          </motion.h1>
